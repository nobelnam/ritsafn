...
# Breyta https://rit.nobel.is/ í https://rit-dev.nobel.is/ fyrir DEV (m.a. fyrir favicon, canonical og mögulega fleira)
find _build/html/ -name '*.html' -exec sed -i '' -e 's|href="https://rit.nobel.is/|href="https://rit-dev.nobel.is/|g' {} +
...
sed -i '' -e 's#<title>.* &ndash; Ritsafn Nóbel námsbúða</title>#<title>Ritsafn Nóbel námsbúða</title>#' _build/html/index.html
